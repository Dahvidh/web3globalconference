          ...
          <div className="w-layout-grid _0-75-1_grid">
            ...
            >
              ...
              <div className="content">
                ...
                <br />
                <p>We extend a warm invitation to  <h6 className="heading-xs">Web3 startups, Entrepreneurs, Developers, Industry leaders, Creators, Web3 communities</h6> </p>
                  ...
                  <div className="padding-global">
                    <div className="padding-section-small">
                      <div className="container-large">
                        <div className="w-layout-grid _0-75-1_grid">
                          <div
                            id="w-node-_4a357a18-8321-d046-fdc2-fd5f168b8932-168b892d"
                            className="content"
                          >
                               ...
                               <br/>
                                <div>
                                  ...
                                  <p>
                                    ...
                                    web3 decision makers and industry experts,
                                    with 90% of attendees comprising
                                ...
                                <div>
                                  ...
                                  <p>
                                    Immerse yourself in an intimate and highly
                                    selective networking environment, limited
                                    to 500 participants, ensuring unparalleled
                              ...
                              <br/>
                                <div>
                                  ...
                                  <p>
                                    ...
                                    seamless onboarding of companies and users
                               ...
                               <br/>
                                <div>
                                  ...
                                  <p>
                                    Experience an exceptional matchmaking day
                                    tailored for esteemed venture capitalists,
                                    meticulously selected startups, and
                                    outstanding individuals, fostering
                                    valuable connections and investment
                                    opportunities.
                                  </p>
                                </div>
                              </div>
